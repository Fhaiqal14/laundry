...
<div class="container">
    <div class="panel">
        <div class="panel-heading">
            <h4><center>Edit Transaksi</center></h4>
        </div>
                ...
                ?>
                    <form method="post" action="transaksi_update.php">
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            ?>
                                <tr>
                                    <td><input type="text" class="formcontrol" name="jenis_pakaian[]" value="<?php echo $p['pakaian_jenis']; ?>"></td>
                                    <td><input type="number" class="formcontrol" name="jumlah_pakaian[]" value="<?php echo $p['pakaian_jumlah']; ?>"></td>
                                </tr>
                            <?php } ?>
                            <tr>
